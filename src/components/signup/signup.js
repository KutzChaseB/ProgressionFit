        ...
        <div className="flex flex-col min-h-screen justify-center items-center bg-pf-gray">
            <div className="w-full max-w-xs bg-pf-white rounded-md">
                <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    ...
                    <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="Password" value={password} onChange={handlePassword}/>
                    </div>
                    <div className="mb-6">
                    <label className="block text-gray-700 text-sm font-bold mb-2">
                        Repeat Password
